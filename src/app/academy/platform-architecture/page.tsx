    ...
    <main className="min-h-screen bg-slate-50 pt-10 pb-24">
      ...
      <article className="max-w-4xl mx-auto px-6 space-y-12">
        ...
        <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm">
          <h3 className="text-lg font-bold text-slate-900 mb-4 px-2">QST Masterclass Video</h3>
          <div className="aspect-video w-full bg-slate-100 rounded-xl overflow-hidden relative shadow-inner">
            <iframe
        ...
        <div className="bg-white border border-slate-200 rounded-3xl p-8 md:p-12 shadow-sm">
          <h2 className="text-2xl font-bold text-slate-900 mb-4 border-b border-slate-100 pb-4">1. Frame Management & Workspaces</h2>
          ...
          <div className="my-10 border-8 border-slate-100 rounded-2xl overflow-hidden shadow-lg">
            <Image
              src="/qst-desktop.png"
        ...
        {/* Section 2 */}
        <div className="bg-white border border-slate-200 rounded-3xl p-8 md:p-12 shadow-sm">
          <h2 className="text-2xl font-bold text-slate-900 mb-4 border-b border-slate-100 pb-4">2. The Price Ladder (Depth of Market)</h2>
          <p className="text-slate-600 mb-6 leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 mt-4">
            <div className="border border-slate-200 rounded-xl p-6 bg-slate-50 border-t-4 border-t-red-500">
              <h4 className="font-bold text-slate-900 mb-2">The Ask Column (Sellers)</h4>
              <p className="text-sm text-slate-600">The red column on the right displays all resting limit sell orders. Clicking inside this column establishes a pending limit order to immediately short the market.</p>
            </div>
            <div className="border border-slate-200 rounded-xl p-6 bg-slate-50 border-t-4 border-t-blue-500">
              <h4 className="font-bold text-slate-900 mb-2">The Bid Column (Buyers)</h4>
              <p className="text-sm text-slate-600">The blue column on the left displays all resting limit buy orders. Visually reading the thickness of these two columns dictates immediate short-term momentum.</p>
            </div>
          </div>
        ...
        {/* Section 3 */}
        <div className="bg-white border border-slate-200 rounded-3xl p-8 md:p-12 shadow-sm">
          <h2 className="text-2xl font-bold text-slate-900 mb-4 border-b border-slate-100 pb-4">3. The Quotes Monitor</h2>
          <p className="text-slate-600 mb-6 leading-relaxed">
        ...
        {/* Section 4 */}
        <div className="bg-white border border-slate-200 rounded-3xl p-8 md:p-12 shadow-sm">
          <h2 className="text-2xl font-bold text-slate-900 mb-4 border-b border-slate-100 pb-4">4. Position Tracking & Account Risk</h2>
          <p className="text-slate-600 mb-6 leading-relaxed">
